    ...
    return (
        <footer className='footer'>
            ...
            <span class="inline-svg">
                <svg xmlns="http://www.w3.org/2000/svg" class="wt-fill-denim wt-width-full" viewBox="0 0 1280 30" preserveAspectRatio="xMidYMid slice" aria-hidden="true" focusable="false">
            ...
            <div className='nav'>
                ...
                <div className='nav-section'>
                    ...
                    <div className='icons'>
                        ...
                        <img src='https://lh3.googleusercontent.com/proxy/ptk97Yc5W2EdgOkVvgyN4fqcABq0bH-RXGK6BBHxe9S4WnbfHaYh1I_c-grMEDDaJJlJ64b8xGgEI_BjmyADyQl327UjhlnYnCnGxWihOM2Vb_8WhIn_kg=s0-d' alt=""/>
                        <img src='https://www.southerntioga.org/wp-content/uploads/2017/09/twitter-white-clear2-circle.png' alt='' />
                        <img src="https://i0.wp.com/www.mtctutorials.com/wp-content/uploads/2019/04/youtube-flag-png-icon-logo-free.png?resize=316%2C223&ssl=1" alt=""/>
                    </div>
                </div>
            </div>
                ...
                <div>
                    <div>
                        <div className='span-container'>
                            <img className='flag' src='https://upload.wikimedia.org/wikipedia/en/thumb/a/a4/Flag_of_the_United_States.svg/1280px-Flag_of_the_United_States.svg.png' alt='' />
                    ...
                    <div className='right-side span-container'>
                        ...
                        <a href=""><span className='right-span'>Terms of Use</span></a>
                        <a href=""><span className='right-span'>Privacy</span></a>
                        <a href=""><span className='right-span'>Interest - based ads</span></a>
                    </div>
                </div>
            </div>
        </footer>
