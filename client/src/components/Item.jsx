...
function Item(props) {
  ...
  if (props.index === randomIndex) {
    price = (
      <div>
        <p className="price">${(props.price * 0.5).toFixed(2)}</p>
        <p className="price smallPrice">
  ...
  if (props.index === randomIndex1) {
    price = (
      <div>
        <p className="price">${(props.price * 0.8).toFixed(2)}</p>
        <p className="price smallPrice">
          <span>${props.price}</span> (20% off)
        </p>
      </div>
    );
  }
  ...
  if (props.index === randomIndex2 || props.index === randomIndex3) {
    price = (
      <div>
        <p className="price">${(props.price * 0.65).toFixed(2)}</p>
        <p className="price smallPrice">
          <span>${props.price}</span> (35% off)
        </p>
      </div>
    );
  }
  ...
  if (props.index === randomIndex4) {
    price = (
      <div>
        <p className="price">${(props.price * 0.3).toFixed(2)}</p>
        <p className="price smallPrice">
          <span>${props.price}</span> (70% off)
        </p>
      </div>
    );
  }
